...
void Menu::leArquivoComPeso()
{
    ...
    if(!infile){
        cout<<"Erro ao Abrir o Arquivo ou Arquivo Nao Existe"<<endl;
        exit(0);
    }
...
void Menu::opcao3()
{
    /* Busca Em Largura */
    int key=0;
    cout<<"Digite o ID do No que deseja iniciar a Busca em largura:"<<endl;
    cin>>key;
    grafoUtilizado->buscaEmLargura(key);
    this->parte_1();
}
